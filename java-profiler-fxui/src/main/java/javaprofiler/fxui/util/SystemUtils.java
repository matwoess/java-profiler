...
public class SystemUtils {
  ...
  public static String getJavaRunCommand(String[] toolArguments) {
    String toolJar = javaprofiler.tool.cli.Main.class.getProtectionDomain().getCodeSource().getLocation().getPath();
    String commonJar = javaprofiler.common.Util.class.getProtectionDomain().getCodeSource().getLocation().getPath();
