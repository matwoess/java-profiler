...
## Introduction
This project was created as part of my master's thesis at the Institute for System Software (SSW) of the Johannes-Kelper University (JKU), located in Linz, Austria.
...
Finally, the metadata and counts will be used to create the report in `.profiler/report/`.
